...
print(get.upper())
'''
#ex2 --- не совсем поняла суть задачи
'''class Shape:
    def __init__(self):
        pass
    def area(self):
...
#ex4 -- нужно упростить, но не знаю как
'''import matplotlib.pyplot as plt
import math
class Point:
    def __init__(self,x,y,x2,y2, new_x,new_y):
        self.x = x
        self.y = y
        self.x2 =x2
        self.y2 =y2
...
print(Point(x,y,x2,y2, new_x,new_y).show())
print(Point(x,y,x2,y2, new_x,new_y).get_dist())
print(Point(x,y,x2,y2, new_x,new_y).move())'''
